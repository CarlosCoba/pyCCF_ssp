...
def main_program():
	if (nargs==6):
		...
		name=sys.argv[4]
		plot=int(sys.argv[5])
		return cube,template_ssp,z,name,plot
		
	else:
		print 'USE: CCF_IFS.py cube.fits template_ssp z OUTPUT plot'
		exit()
...
def ccf(cube,template_ssp,z,name,plot):
	#import this scripts
...
if __name__ == "__main__":
	main=main_program()
	ccf(main[0],main[1],main[2],main[3],main[4])
#else:
#	ccf()	
